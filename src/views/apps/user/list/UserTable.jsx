...
const UserTable = () => {
  ...
  const getUserList = async () => {
    try{
      const result = await axios.get("https://acadapi.etacorealtime.ir/api/User/UserMannage?PageNumber=0&RowsOfPage=0&SortingCol=DESC&SortType=InsertDate&Query=&IsActiveUser=true&IsDeletedUser=true&roleId=1")
